...
describe('superdesk.asset module', function() {
    ...
    it('can get templateUrl for absolute path', function() {
        var templateUrl = asset.templateUrl('http://localhost/scripts/superdesk-users/views/user-list-item.html');
        expect(templateUrl).toBe('http://localhost/scripts/superdesk-users/views/user-list-item.html');
    });
