...
import superdesk
from publicapi.prepopulate.service import PrepopulateService
from publicapi.prepopulate.resource import PrepopulateResource
import publicapi.prepopulate.command  # NOQA
