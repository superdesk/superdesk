...
class PublishedItemService(BaseService):
    ...
    def remove_expired(self, doc):
        ...
        Removes the expired published article from 'published' collection. Below is the workflow:
            1.  If doc is a package then recursively move the items in the package to legal archive if the item
                wasn't moved before. And then run the package through the expiry workflow.
